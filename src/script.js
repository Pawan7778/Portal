...
bakedTexture.encoding = THREE.sRGBEncoding //for better color(to input sRGB)
/**
 * Materails
 */
//Baked material
...
firefliesGeometry.setAttribute('position', new THREE.BufferAttribute(positionArray, 3)) //here bufferAttributes take array and how many values per vertex
...
const firefliesMaterial = new THREE.ShaderMaterial({
    ...
    depthWrite : false   //to see the particle behind front particle
})
